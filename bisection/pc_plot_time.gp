...
plot 'pc_time_data.txt' using 1:2 title 'Pc = 0.70' with linespoints ls 1, \
    'pc_time_data.txt' using 1:3 title 'Pc = 0.80' with linespoints ls 2, \
    'pc_time_data.txt' using 1:4 title 'Pc = 0.90' with linespoints ls 3
unset multiplot
