...
The abstracts slopes are reduced to three different cases: 1 for growing, -1 for decreasing and 0 for plain areas or unreliable difference. Since we have three different slopes, there are nine different cases that need to handled by the algorithm, which we describe in the following pictures.

    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case1}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case2}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case3}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case4}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case5}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case6}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case7}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case8}
        \caption{Caption}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.45]{mid_case9}
        \caption{Caption}
    \end{figure}
